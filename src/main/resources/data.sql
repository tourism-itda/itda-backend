...
-- ---------- place ----------
INSERT INTO place (place_id, name, category, description, latitude, longitude, address, region, opening_hours, kakao_place_id) VALUES
 (1,  '성산일출봉',       '자연',   '유네스코 세계자연유산, 일출 명소',        33.458031, 126.942520, '제주 서귀포시 성산읍 일출로 284-12', '제주', '07:00~20:00',        'kakao-1001'),
 (2,  '협재해수욕장',     '해변',   '에메랄드빛 바다와 비양도 전망',           33.394046, 126.239621, '제주 제주시 한림읍 협재리',           '제주', '상시개방',            'kakao-1002'),
 (3,  '한라산국립공원',   '산',     '남한 최고봉, 사계절 트레킹',              33.361667, 126.529167, '제주 제주시 1100로 2070-61',          '제주', '05:00~일몰',          'kakao-1003'),
 (4,  '우도',             '섬',     '소가 누운 형상의 섬, 땅콩아이스크림',     33.500623, 126.953014, '제주 제주시 우도면',                  '제주', '페리 운항시간',       'kakao-1004'),
 (5,  '천지연폭포',       '폭포',   '밤에도 조명이 켜지는 3대 폭포',           33.246505, 126.554021, '제주 서귀포시 천지동',                '제주', '09:00~22:00',        'kakao-1005'),
 (6,  '카멜리아힐',       '정원',   '동백 정원, 인생샷 명소',                  33.291560, 126.368970, '제주 서귀포시 안덕면 병악로 166',     '제주', '08:30~18:00',        'kakao-1006'),
 (7,  '오설록티뮤지엄',   '카페',   '녹차밭과 티 뮤지엄',                      33.305500, 126.289600, '제주 서귀포시 안덕면 신화역사로 15',  '제주', '09:00~18:00',        'kakao-1007'),
 (8,  '경복궁',           '고궁',   '조선의 법궁, 수문장 교대식',              37.579617, 126.977041, '서울 종로구 사직로 161',              '서울', '09:00~18:00(화휴무)', 'kakao-2001'),
 (9,  '북촌한옥마을',     '전통마을', '한옥이 밀집한 전통 골목',               37.582604, 126.983001, '서울 종로구 계동길 37',               '서울', '상시개방',            'kakao-2002'),
 (10, 'N서울타워',        '전망대', '남산 정상의 서울 야경 명소',              37.551169, 126.988227, '서울 용산구 남산공원길 105',          '서울', '10:00~23:00',        'kakao-2003'),
 (11, '광장시장',         '시장',   '빈대떡·마약김밥 먹거리 천국',             37.570028, 126.999790, '서울 종로구 창경궁로 88',             '서울', '09:00~23:00',        'kakao-2004'),
 (12, '인사동',           '거리',   '전통 공예와 찻집 거리',                   37.574040, 126.985620, '서울 종로구 인사동길',                '서울', '상시개방',            'kakao-2005'),
 (13, '창덕궁',           '고궁',   '유네스코 세계유산, 후원이 아름다운 궁',   37.579391, 126.991001, '서울 종로구 율곡로 99',               '서울', '09:00~18:00(월휴무)', 'kakao-2006'),
 (14, '홍대',             '거리',   '젊음의 거리, 버스킹과 카페',              37.556279, 126.923657, '서울 마포구 양화로',                  '서울', '상시개방',            'kakao-2007');
